            ...
            for i in range(0, length):
                ...
                if test_string[i] is "3":
                    if testrotation is 0:
                        ...
                        testrotation = 1
                if test_string[i] is "4":
                    if testrotation is 0:
                        if (x < 1 or x >10 or y-1 < 1 or y-1 > 10) or aList[x - 1][y-2] is "wall":
                            return False
                        y -= 2

                    if testrotation is 1:
                        if (x+1 < 1 or x+1 >10 or y < 1 or y > 10) or aList[x][y-1] is "wall":
                            return False
                        x += 2
                    if testrotation is 2:
                        if (x < 1 or x >10 or y+1 < 1 or y+1 > 10) or aList[x-1][y] is "wall":
                            return False
                        y += 2
                    if testrotation is 3:
                        if (x-1 < 1 or x-1 >10 or y < 1 or y > 10) or aList[x-2][y-1] is "wall":
                            return False
                        x -= 2
                if test_string[i] is "5":
                    if testrotation is 0:
                        if(x < 1 or x >10 or y+1 < 1 or y+1 > 10) or aList[x - 1][y] is "wall" :
                            return False
                        y += 2
            ...
            if self.robot.speedUP is 1:
                for i in range(0, 6):
                    ...
                    if i is 3:
                         returnedString = AI.thestring(self, num - 1, nowString + "3", aList)
                    if i is 4:
                         returnedString = AI.thestring(self, num - 1, nowString + "4", aList)
                    if i is 5:
                         returnedString = AI.thestring(self, num - 1, nowString + "5", aList)
                    if returnedString != " ":
                         return returnedString
                #把真正的值向上传递
            return " "
...
#            self.robot.doNothing()
        ...
        if the_string_I_want[0] is "0":
            ...
            print("Right")
            self.robot.turnRight()
        elif the_string_I_want[0] is "4":
            print("Forth2")
            self.robot.goForth2()
        elif the_string_I_want[0] is "5":
            print("Back2")
            self.robot.goBack2()
